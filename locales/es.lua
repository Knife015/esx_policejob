Locales['es'] = {
  ...
  ['vehicle_blocked'] = 'Todos los puntos de spawn están bloqueados!',
  ...
  ['garage_has_stored'] = 'el vehículo fue almacenado en el garaje',
  ['garage_has_notstored'] = 'no nearby owned vehicles were found',
  ['garage_notavailable'] = 'tú vehículo no esta almacenado en el garaje.',
